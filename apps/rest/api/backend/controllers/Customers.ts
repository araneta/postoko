...
import { customersTable, customerPurchasesTable, storeInfoTable, ordersTable, orderItemsTable, productsTable, customerLoyaltyPointsTable, loyaltyTransactionsTable, loyaltySettingsTable } from '../db/schema.js';
